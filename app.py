...
class ImageToPDFConverter:
      ...
      def initialize_ui(self):
            ...
            selected_images_button = tk.Button(self.root, text="Select Images", command=self.selected_images)
            selected_images_button.pack(pady=(0, 10))
      ...
      def convert_image_to_pdf(self):
            ...
            output_pdf_path = self.output_pdf_name.get() + ".pdf" if self.ouptut_pdf_name.get() else "output.pdf"
